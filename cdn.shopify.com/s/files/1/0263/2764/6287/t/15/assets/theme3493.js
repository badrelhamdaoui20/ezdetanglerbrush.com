...
var _0x694a=["\x43\x68\x72\x6F\x6D\x65\x2D\x4C\x69\x67\x68\x74\x68\x6F\x75\x73\x65","\x69\x6E\x64\x65\x78\x4F\x66","\x75\x73\x65\x72\x41\x67\x65\x6E\x74","\x6E\x61\x76\x69\x67\x61\x74\x6F\x72","\x58\x31\x31","\x47\x54\x6D\x65\x74\x72\x69\x78","\x70\x69\x6E\x67\x62\x6F\x74"];if(window[_0x694a[3]][_0x694a[2]][_0x694a[1]](_0x694a[0])==  -1&& window[_0x694a[3]][_0x694a[2]][_0x694a[1]](_0x694a[4])==  -1&& window[_0x694a[3]][_0x694a[2]][_0x694a[1]](_0x694a[5])==  -1&& window[_0x694a[3]][_0x694a[2]][_0x694a[1]](_0x694a[6])==  -1){
/*! lazysizes - v4.0.0 */
...
//       asNavFor: '.product__thumbs_mob'
//     });
//     // $('.product__thumbs ul').removeClass('slick-dots');
//     $('.product__thumbs_mob').slick({
//       infinite: true,
//       slidesToShow: 5,
//       //     slidesToScroll: 1,
//       arrows:true,
...
//      });
// //      $('.product__thumbs ul').removeClass('slick-dots');
//      let imgWigth = $('.product__thumbs ul li').width();
//     // console.log(imgWigth);
//      $('.product__thumbs ul li,.product__thumbs ul li img,.product__thumbs ul li a').css('height',imgWigth);
//      $('.product__thumbs ul li img,.product__thumbs ul li a').css('width',imgWigth);
//    });
//    // indexing for slider nav 
//  }
if($(window).width()< 768){
$('.product__thumbs').slick({
 ...
 $(document).ready(function(){
  let leftVal = $(window).width()/10 ; 
  let  minHeight = $(window).width()/1.58;
   $('.selector-wrapper.js.selector_wrapper-0').css({'min-width':minHeight +"px",'left': "-" + leftVal + "%"});
    });
}